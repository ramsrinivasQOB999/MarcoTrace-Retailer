...
import com.mercotrace.retailer.config.Constants;
import com.mercotrace.retailer.domain.User;
import com.mercotrace.retailer.repository.UserRepository;
import com.mercotrace.retailer.security.AuthoritiesConstants;
import com.mercotrace.retailer.service.MailService;
import com.mercotrace.retailer.service.UserService;
import com.mercotrace.retailer.service.dto.AdminUserDTO;
import com.mercotrace.retailer.web.rest.errors.BadRequestAlertException;
import com.mercotrace.retailer.web.rest.errors.EmailAlreadyUsedException;
import com.mercotrace.retailer.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.mercotrace.retailer.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
@Tag(
    ...
    description = "Admin-only user lifecycle (`ROLE_ADMIN`). Paths are under `/api/admin`."
)
