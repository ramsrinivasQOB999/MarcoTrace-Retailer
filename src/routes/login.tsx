        ...
        <div className="hidden lg:flex flex-col justify-between p-10 text-white">
          ...
          <div className="space-y-4 max-w-md">
            ...
            <p className="text-white/90">
              Lot-level inventory, GST-ready POS, expiry & margin alerts, and aging insights — across every store in your agglomeration.
            </p>
            ...
            {stage === "phone" ? (
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    All four roles can sign in — sidebar adapts to your role.
                  </p>
                </div>
                <Button
                  type="submit"
                  className="w-full text-primary-foreground hover:opacity-95"
                  style={{ backgroundImage: "linear-gradient(135deg, #5B8DEF 0%, #6C63FF 100%)" }}
                >
                  Send OTP
                </Button>
              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    className="flex-1 text-primary-foreground hover:opacity-95"
                    style={{ backgroundImage: "linear-gradient(135deg, #5B8DEF 0%, #6C63FF 100%)" }}
                    onClick={verify}
