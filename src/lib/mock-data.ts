...
export const stores: Store[] = [
  ...
  },
  {
    id: "s2",
    code: "MUM",
    name: "Mercotrace Andheri",
    city: "Mumbai",
    agglomeration: "West Cluster",
    status: "active",
    owner: "P. Shah",
  ...
  },
  {
    id: "s3",
    code: "DEL",
    name: "Mercotrace Saket",
    city: "New Delhi",
    agglomeration: "North Cluster",
    status: "pending",
    owner: "A. Khanna",
...
export const lots: Lot[] = [
  {
    id: "l1",
    skuId: "k1",
    skuCode: "FMC-BEV-COL-500-001",
    storeId: "s1",
    qty: 240,
    remaining: 180,
    costPrice: 28,
    sellPrice: 40,
    purchaseDate: addDays(-20),
  ...
  },
  {
    id: "l2",
    skuId: "k2",
    skuCode: "FMC-SNK-CHP-100-002",
    storeId: "s1",
    qty: 120,
    remaining: 28,
    costPrice: 18,
    sellPrice: 30,
    purchaseDate: addDays(-45),
...
export const sales: Sale[] = [
  {
    ...
    date: addDays(-1),
    items: [
      { skuCode: "FMC-BEV-COL-500-001", qty: 2, price: 40 },
      { skuCode: "FMC-SNK-CHP-100-002", qty: 1, price: 30 },
    ],
    total: 110,
    gst: 21.4,
    payment: "upi",
  },
  {
    ...
    storeId: "s2",
    date: addDays(0),
    items: [{ skuCode: "DRY-RIC-BAS-1KG-003", qty: 3, price: 145 }],
    total: 435,
    gst: 21.75,
    payment: "cash",
  },
  {
    ...
    storeId: "s1",
    date: addDays(0),
    items: [{ skuCode: "PER-MLK-FCM-1LT-004", qty: 4, price: 68 }],
    total: 272,
    gst: 0,
    payment: "card",
  },
...
export function effectiveCost(
  ...
  return (
    cp * q + interestCost(cp, q, ratePct, daysHeld) + wastageCost(cp, q, daysHeld, expiryWindow)
  );
}
